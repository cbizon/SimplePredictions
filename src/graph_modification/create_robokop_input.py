...
def create_robokop_input(node_file="input_graphs/robokop_base_nodes.jsonl", 
                        edges_file="input_graphs/robokop_base_edges.jsonl", 
                        style="CCDD", 
                        output_dir="graphs"):
    """Create filtered graph for analysis.
    
    Args:
        node_file: Path to nodes file
    ...
    write_pecanpy_input(edges_file, graph_dir, remove_edge, typemap)
...
def main():
    ...
    parser.add_argument("--nodes", default="input_graphs/robokop_base_nodes.jsonl",
                       help="Path to nodes file")
    parser.add_argument("--edges", default="input_graphs/robokop_base_edges.jsonl", 
