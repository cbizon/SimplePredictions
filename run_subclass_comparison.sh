...
uv run python src/modeling/evaluate_model.py --model-dir graphs/robokop_base_nonredundant_no_filter/embeddings/embeddings_0/models/model_0
uv run python src/modeling/evaluate_model.py --model-dir graphs/robokop_base_nonredundant_CCDD/embeddings/embeddings_0/models/model_0
...
uv run python src/modeling/evaluate_model.py --model-dir graphs/robokop_base_nonredundant_no_filter/embeddings/embeddings_0/models/model_1
