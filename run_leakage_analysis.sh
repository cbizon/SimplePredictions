...
# Leaky variants (new)
uv run python src/graph_modification/create_robokop_input.py --style CCDD_with_cd
uv run python src/graph_modification/create_robokop_input.py --style CCDD_with_subclass_with_cd
uv run python src/graph_modification/create_robokop_input.py --style CGD_with_cd
uv run python src/graph_modification/create_robokop_input.py --style CGD_with_subclass_with_cd
#
#echo "✓ Graphs created"
#echo ""
...
uv run python src/embedding/generate_embeddings.py --graph-file graphs/robokop_base_nonredundant_CCDD_with_cd/graph/edges.edg $EMBEDDING_PARAMS 
uv run python src/embedding/generate_embeddings.py --graph-file graphs/robokop_base_nonredundant_CCDD_with_subclass_with_cd/graph/edges.edg $EMBEDDING_PARAMS 
uv run python src/embedding/generate_embeddings.py --graph-file graphs/robokop_base_nonredundant_CGD_with_cd/graph/edges.edg $EMBEDDING_PARAMS 
uv run python src/embedding/generate_embeddings.py --graph-file graphs/robokop_base_nonredundant_CGD_with_subclass_with_cd/graph/edges.edg $EMBEDDING_PARAMS 
